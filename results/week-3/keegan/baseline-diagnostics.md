...
|---|---:|---:|---:|---:|
| position_only | 0.3533 | 0.3460 | 0.3250 | 0.3179 |
| orientation_only | 0.8733 | 0.8732 | 0.9000 | 0.9005 |
| position_plus_orientation | 0.9017 | 0.9032 | 0.8950 | 0.8953 |

## Leakage controls

- Five-class chance accuracy: 0.2000.
- Permuted-label logistic mean test accuracy: 0.1910.
- Permuted-label random-forest mean test accuracy: 0.1717.
- Safe metadata-only logistic test accuracy: 0.1900.
...
|---|---:|---:|---:|---:|
| logistic_regression | 0.9017 ± 0.0000 | 0.9032 ± 0.0000 | 0.2432 ± 0.0548 | 0.9447 ± 0.1519 |
| random_forest | 0.8933 ± 0.0033 | 0.8936 ± 0.0033 | 12.7610 ± 0.4017 | 14.1448 ± 1.4158 |
...
- Test windows with an exact training orientation match: 0.
